...
class Rptbukubesar extends Bismillah_Controller{
  ...
  public function loadgrid(){
    $va     = json_decode($this->input->post('request'), true) ; 
      ...
      $dbd    = $vdb['db'] ;
      $n = 0 ; 
      $vare[0] = array("no"=>"","tgl"=>"","faktur"=>"","keterangan"=>"Saldo Awal","debet"=>"","kredit"=>"","total"=> string_2s($vdb['saldoawal']),"username"=>"","cmddelete"=>"") ;
    $total = $vdb['saldoawal'] ;
      ...
      if(!empty($data)){  
        ...
        $this->bospdf->ezTable($data1,"","",  
                array("fontSize"=>$font,"cols"=> array( 
                           ...
                           "cmddelete"=>array("width"=>1,"justification"=>"right"),
